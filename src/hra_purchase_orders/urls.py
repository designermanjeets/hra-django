...
urlpatterns = [
    ...
    path('get/<int:pk>/orders', PurchaseOrderListByCustomer.as_view(), name='purchase-order-list'),
    ...
    path("employeesassignorder/get",Employeesassignorder.as_view(),name='Employeesassignorder')
